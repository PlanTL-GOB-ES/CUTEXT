...
public class StopWordsCat implements StopInterface, Cloneable, Serializable
{
	...
	public StopWordsCat clone()
	{
		StopWordsCat s = null;
		try
		{
			s = (StopWordsCat)super.clone();
		}
	...
	public StopWordsCat(DatosEntrada datos)
	{
		this.datos = datos;
	}
