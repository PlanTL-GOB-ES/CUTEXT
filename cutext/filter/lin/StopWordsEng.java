...
public class StopWordsEng implements StopInterface, Cloneable, Serializable
{
	...
	public StopWordsEng clone()
	{
		StopWordsEng s = null;
		try
		{
			s = (StopWordsEng)super.clone();
		}
	...
	public StopWordsEng(DatosEntrada datos)
	{
		this.datos = datos;
	}
