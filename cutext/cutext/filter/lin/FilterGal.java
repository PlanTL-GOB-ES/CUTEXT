...
public class FilterGal implements FilterInterface, Cloneable, Serializable
{
	...
	public FilterGal clone()
	{
		FilterGal f = null;
		try
		{
			f = (FilterGal)super.clone();
		}
	...
	public FilterGal(Frase corpus, DatosEntrada datos)
	{
		this.datos = datos;
		inicializar();
		this.corpus = corpus;
