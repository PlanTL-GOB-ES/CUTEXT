...
public class FilterCat implements FilterInterface, Cloneable, Serializable
{
	...
	public FilterCat clone()
	{
		FilterCat f = null;
		try
		{
			f = (FilterCat)super.clone();
		}
	...
	public FilterCat(Frase corpus, DatosEntrada datos)
	{
		this.datos = datos;
		inicializar();
		this.corpus = corpus;
